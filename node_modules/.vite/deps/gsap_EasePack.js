  ...
  if (gsap) {
    ...
    var eases = gsap.parseEase(), createConfig = function createConfig2(ease) {
      return function(ratio) {
        var y = 0.5 + ratio / 2;
        ease.config = function(p2) {
          return ease(2 * (1 - p2) * p2 * y + p2 * p2);
        };
      };
    }, p;
    for (p in eases) {
...
var _createRoughEase = function _createRoughEase2(vars) {
  ...
  return function(p) {
    var pnt2 = recent;
    if (p > pnt2.t) {
      while (pnt2.next && p >= pnt2.t) {
        pnt2 = pnt2.next;
      }
      pnt2 = pnt2.prev;
    } else {
      while (pnt2.prev && p <= pnt2.t) {
        pnt2 = pnt2.prev;
      }
    }
    recent = pnt2;
    return pnt2.v + (p - pnt2.t) / pnt2.gap * pnt2.c;
  };
};
...
gsap/EasePack.js:
  ...
  *)
*/
//# sourceMappingURL=gsap_EasePack.js.map
